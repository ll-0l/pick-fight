...
PICK FIGHT는 최소 3개 이상의 섹션을 제공하며 상단 메뉴를 통해 이동할 수 있습니다.
...
Gemini API 사용량 또는 호출량 제한으로 `429 RESOURCE_EXHAUSTED` 오류가 발생할 수 있습니다.
...
PICK FIGHT는 데스크톱뿐 아니라 모바일 / 태블릿 환경에서도 사용할 수 있도록 반응형 레이아웃을 적용합니다.
...
최소 데스크톱과 모바일 두 가지 화면 크기에서 직접 테스트합니다.
